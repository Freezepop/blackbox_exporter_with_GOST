...
// DialTLSContextFunc defines the signature used by http.Transport for an
// already-handshaken TLS connection.
...
// WithDialTLSContextFunc overrides the TLS dialer used by http.Transport.
// The returned connection must have completed its TLS handshake.
