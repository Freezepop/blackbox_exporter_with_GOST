...
func getTLSCipher(state *tls.ConnectionState) string {
	...
	case 0x0081:
		return "GOST2001-GOST89-GOST89"
	case 0xff85:
		return "GOST2012-GOST8912-GOST8912"
	case 0xc100:
		return "GOST2012-KUZNYECHIK-KUZNYECHIK"
	case 0xc101:
		return "GOST2012-MAGMA-MAGMA"
	case 0xfffe:
		return "GOST (OpenSSL engine)"
	}
